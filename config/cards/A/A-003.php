...
return  new
    ...
    class extends \App\Card {
        ...
        {
            yield        "Speed +1d6 (rolled when attached";
            yield   "to the Monster).";
        }
