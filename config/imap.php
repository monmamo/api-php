...
return [
    ...
    */
    'options' => [
        'delimiter' => '/',
        'fetch' => \App\Email\IMAP::FT_PEEK,
        'sequence' => \App\Email\IMAP::ST_UID,
        'fetch_body' => true,
        'fetch_flags' => true,
        'soft_fail' => false,
        'rfc822' => true,
    ...
    'events' => [
        "message" => [
            'new' => \App\Email\Events\MessageNewEvent::class,
            'moved' => \App\Email\Events\MessageMovedEvent::class,
            'copied' => \App\Email\Events\MessageCopiedEvent::class,
            'deleted' => \App\Email\Events\MessageDeletedEvent::class,
            'restored' => \App\Email\Events\MessageRestoredEvent::class,
        ],
        "folder" => [
            'new' => \App\Email\Events\FolderNewEvent::class,
            'moved' => \App\Email\Events\FolderMovedEvent::class,
            'deleted' => \App\Email\Events\FolderDeletedEvent::class,
        ],
        "flag" => [
            'new' => \App\Email\Events\FlagNewEvent::class,
            'deleted' => \App\Email\Events\FlagDeletedEvent::class,
        ],
    ],
     ...
     */
    'masks' => [
        'message' => \App\Email\Support\Masks\MessageMask::class,
        'attachment' => \App\Email\Support\Masks\AttachmentMask::class
    ]
];