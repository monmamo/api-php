...
use Spatie\Ignition\Solutions\SolutionProviders as Ignition;
...
return [
    ...
    | Supported: "phpstorm", "vscode", "vscode-insiders", "textmate", "emacs", "sublime", "atom", "nova", "macvim", "idea", "netbeans", "xdebug"
    */
