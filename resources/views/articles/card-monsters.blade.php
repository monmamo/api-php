...
<p>These are the cards we are working on now:</p>
   ...
   <div class="container">
      <div class="d-flex flex-row">
        <div class="p-2"><x-card cardNumber="A-M-01" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-M-02" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-M-03" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-M-04" width="200"/></div>
    </div>
    <div class="d-flex flex-row">
        <div class="p-2"><x-card cardNumber="A-M-06" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-M-07" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-M-08" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-M-09" width="200"/></div>
    </div>
    <div class="d-flex flex-row">
        <div class="p-2"><x-card cardNumber="A-M-10" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-M-11" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-M-13" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-M-14" width="200"/></div>
    </div>  
    <div class="d-flex flex-row">
...
Work in progress: A-M-17
    ...
    <div class="d-flex flex-row">
        ...
        <div class="p-2"><x-card cardNumber="A-038" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-041" width="200"/></div>
    </div>
    <div class="d-flex flex-row">
        <div class="p-2"><x-card cardNumber="A-042" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-052" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-053" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-059" width="200"/></div>
    </div>
    <div class="d-flex flex-row">
        <div class="p-2"><x-card cardNumber="A-060" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-065" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-066" width="200"/></div>
        <div class="p-2"><x-card cardNumber="A-076" width="200"/></div>
    </div>
    <div class="d-flex flex-row">
        <div class="p-2"><x-card cardNumber="A-079" width="200"/></div>
    </div>
--}}
    @endfragment