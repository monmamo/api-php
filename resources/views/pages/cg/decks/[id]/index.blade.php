...
<x-guest-layout>
    ...
    <x-slot:page-title><?= $deck->name ?> | Classic Monster Battle Card Game</x-slot>

        <x-breadcrumbs :items="['/cg'=>'Classic Monster Battle Card Game', '/cg/rules'=>'Rules','/cg/decks'=>'Available Decks']" />
