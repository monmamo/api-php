<x-guest-layout>
    ...
    <x-slot:page-title>Card Game Rules</x-slot>

        <div class="row">
            <div class="col-3">
                <nav id="page-toc" class="h-100 flex-column align-items-stretch pe-4 border-end">
                    <nav class="nav nav-pills flex-column">
                        <a class="nav-link" href="#game-layout">Game Layout</a>
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ms-3" href="#game-layout-battlefield">Battlefield</a>
                            <a class="nav-link ms-3" href="#game-layout-library">Library</a>
                            <a class="nav-link ms-3" href="#game-layout-discard">Discard</a>
                            <a class="nav-link ms-3" href="#game-layout-exile">Exile</a>
                            </nav>
            <a class="nav-link" href="#card">Elements of a Card</a>
                        <a class="nav-link" href="#setup">Setup</a>
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ms-3" href="#setup-exile">Battle Format and Objective</a>
                            <a class="nav-link ms-3" href="#setup-draft">Draft</a>
                            <a class="nav-link ms-3" href="#setup-place-cards">Putting Cards Into the Battlefield</a>
                            <a class="nav-link ms-3" href="#setup-completing">Completing Setup</a>
                        </nav>
                    </nav>
            </div>
            <div class="col-9">
                <h2 id="game-layout">Game Layout</h2>
                <h3 id="game-layout-battlefield">The Battlefield</h3>
                ...
                <h3 id="game-layout-library">Library</h3>
                ...
                <h3 id="game-layout-discard">Discard</h3>
                ...
                <h3 id="game-layout-exile">Exile</h3>
...
<li>Level: A number indicating the relative experience of the Monster.</li>
<li>Size: A number indicating the relative size of the Monster.</li>
<li>Speed: A number indicating the relative speed of the Monster.</li>
