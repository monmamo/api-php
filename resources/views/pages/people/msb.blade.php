<x-guest-layout>
 <x-breadcrumbs>
        <x-breadcrumbs.crumb url="/people">People of Monsters Masters & Mobsters</x-breadcrumbs.crumb>
    </x-breadcrumbs>

<div class="container col-xxl-8 px-4 py-1">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-1">
      <div class="col-10 col-sm-8 col-lg-6">
        <img src="@publicimage(msb.jpg)" class="d-block mx-lg-auto img-fluid" alt="picture of Merry Shuporna Biswas" width="500" height="500" loading="lazy">
      </div> 
      <div class="col-lg-6">
        <h1 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">Merry Shuporna Biswas</h1>
        <p class="lead">Merry is a talented artist and full-time freelancer from Dhaka, Bangladesh. She specializes in both traditional and digital art styles, creating unique and captivating pieces. Merry's journey into the world of freelancing began when she left her hometown in search of new adventures. </p>
      </div>
    </div>
  </div>

<h2>Merry's Card Art</h2>
