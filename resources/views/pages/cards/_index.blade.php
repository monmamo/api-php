                ...
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="dropdown-menu" hx-boost="true" hx-target="#left-section" hx-swap="innerHTML">
                            <li><a class="dropdown-item" href="<?= app('url')->route('deck',['id'=>'sdv-library'])  ?>">SDV Library</a></li>
                            <li><a class="dropdown-item" href="<?= app('url')->route('deck',['id'=>'sdv-monsters']) ?>">SDV Monsters</a></li>
                            <li><a class="dropdown-item" href="<?= app('url')->route('deck',['id'=>'pdv-e']) ?>">PDV Electricty Starter</a></li>
                            <li><a class="dropdown-item" href="<?= app('url')->route('deck',['id'=>'pdv-f']) ?>">PDV Fire Starter</a></li>
                            <li><a class="dropdown-item" href="<?= app('url')->route('deck',['id'=>'pdv-w']) ?>">PDV Water Starter</a></li>
                        </ul>
                    </li>
                </ul>
