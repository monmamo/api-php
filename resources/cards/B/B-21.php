...
return new
#[\App\GeneralAttributes\Title('Earthquake')]

    #[\App\Concept('Catastrophe')]



    #[\App\CardAttributes\ImageCredit('Image by Lorc on Game-Icons.net under CC BY 3.0')]
