...
{{-- https://game-icons.net/1x1/lorc/turd.html --}}
 ...
 [
Resolution phase: Roll 1d4.
If ⚀, discard this card.
Each other Monster in play takes 1d4-1 damage.
    ],
    "stats": null,
    "subtypes": [],
    @push('flavor-text')
<x-card.flavor-text-line>The smell is the least of your worries.</x-card.flavor-text-line>
@endpush
}