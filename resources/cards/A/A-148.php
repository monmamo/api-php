...
return new
#[\App\GeneralAttributes\Title('Embargo')]

    #[\App\Concept('Environment')]



    #[\App\CardAttributes\ImageCredit('Image by Delapouite and Lorc on Game-Icons.net')]


    'background' => \view('Environment.background'),

    // https://game-icons.net/1x1/lorc/interdiction.html
