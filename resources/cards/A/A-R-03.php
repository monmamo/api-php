...
<x-card.cardrule y="560" lines="2">
<x-card.normalrule>Innate. Any card with a</x-card.normalrule>
<x-card.normalrule>Speed stat can use Dodge.</x-card.normalrule>
        </x-card.cardrule>

<x-card.phaserule type="Resolution" lines="2"><text>
<x-card.normalrule x="55%">Prevents Speed @damage.</x-card.normalrule>
