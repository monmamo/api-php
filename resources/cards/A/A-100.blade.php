<x-card.Upkeep :$cardNumber card-name="Full Heal" >

</x-card.Upkeep>
    <x-slot:card-rules>Remove all Banes from any one Monster.</x-slot:card-rules>
    "stats": null,
    "subtypes": [
Healing","Item
    ],
...
@endpush
    ...
    "_inspiration": [
Full Heal PTCG card
https://bulbapedia.bulbagarden.net/wiki/Full_Heal_(Rebel_Clash_159)
    ]
}
