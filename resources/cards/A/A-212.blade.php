...
{{-- https://www.freepik.com/free-vector/recycle-colorful-geometric-gradient-logo-vector_27230675.htm --}}
    ...
    @push('flavor-text')
<x-card.flavor-text-line>Recycle today for a better upkeep phase tomorrow.</x-card.flavor-text-line>
@endpush
}
