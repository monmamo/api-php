...
@push('flavor-text')
<x-card.flavor-text-line>Get the tissues.</x-card.flavor-text-line>
@endpush
...
<x-card  :$cardNumber card-name="Unknown Allergen" >
    ...
    <x-card.rulebox>
        ...
        <x-slot:normal>
Resolution phase: For 1d6 turns,
once all other effects have been resolved,
this Monster takes 1d6 damage.
</x-slot:normal>
</x-card.rulebox>
