...
return new
    #[ImageCredit('Donut icon by Delapouite on Game-Icons.net')]
    #[Title('Baker\'s Dozen')]
    #[Concept('Draw')]
...
HTML;
        ...
        <x-card.phaserule type="Draw" ><text>
            <x-card.ruleline>Look at the top 13 cards of your</x-card.ruleline>
