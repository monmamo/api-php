...
final class TrueOption implements Dumps, Emptyable, Expression, Filterable, Foldable, HasValue, Mappable, Normalizable, Optional, TransformativeInvoker
{
    use AlwaysGettable;
    use AlwaysScalar;
    ...
    {
        return \App\Callables\filter($predicate, $this, true);
    }
    ...
    {
        return \App\Callables\filterNot($predicate, $this, true);
    }
    ...
    {
        return \App\Callables\transform(arity: 1, transforms: $callable, seed: true);
    }
    ...
    {
        return \App\Options\foldLeft($callable, $initial_value, true);
    }
    ...
    {
        return \App\Options\foldRight($callable, $initial_value, true);
    }
